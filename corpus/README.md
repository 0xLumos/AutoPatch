...
The corpus spans real projects of three broad kinds: Go command-line
tools whose binaries carry their dependencies (restic, croc, lazygit,
hugo, kubo, memos, headscale, victoriametrics, navidrome, sftpgo,
etcd), Python and PHP web applications with interpreter-managed
dependencies (healthchecks, changedetection, snipe-it, dolibarr,
mealie, tandoor-recipes, etherpad, wger, superset), and infrastructure
services (registry). Final-stage base images break down as 13 Alpine,
10 Python (slim/base), 4 Ubuntu, 3 Debian, 3 BusyBox, 3 Node, 1 Go,
1 PHP, and 1 custom base; every image is linux/amd64 and every pinned
base was at least 18 months old at collection time.
